...
var ChatListDrawer = function ChatListDrawer(props) {
  ...
  }, context.conn !== null && context.conn.renderChatList ? context.conn.renderChatList(context) : /*#__PURE__*/React__default.createElement(ChatList, _extends({}, allProps, {
    onClose: function onClose() {
...
var ChatSettingsDrawer = function ChatSettingsDrawer(props) {
  ...
  }, "Chat Settings")), context.conn !== null && context.conn.renderChatSettings ? context.conn.renderChatSettings(context) : /*#__PURE__*/React__default.createElement(ChatSettings, allProps)));
};
var styles$8 = {
  drawerContainer: {
    position: 'fixed',
...
var Message$1 = function Message$1(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    offset: conn.offset
  }), message.sender_username === conn.userName || message.sender_username === conn.senderUsername ? /*#__PURE__*/React__default.createElement(Message, {
    chat: chat,
    conn: conn,
    sending: !message.id,
...
var FormHtmlEditor = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, /*#__PURE__*/React__default.createElement(Quill, {
      theme: "snow",
      modules: modules,
      formats: formats,
...
var NewMessageForm$1 = function NewMessageForm() {
  ...
  var _useState5 = React.useState(false),
      loadQuill = _useState5[0],
      setLoadQuill = _useState5[1];

  React.useEffect(function () {
    return setLoadQuill(true);
  }, 100);
  ...
  }), loadQuill && /*#__PURE__*/React__default.createElement(FormHtmlEditor, {
    theme: "snow",
    value: value,
...
var ChatFeed = function ChatFeed(props) {
  ...
  }), needsIceBreaker && props.renderIceBreaker && props.renderIceBreaker(chat), needsIceBreaker && !props.renderIceBreaker && /*#__PURE__*/React__default.createElement(IceBreaker, null), /*#__PURE__*/React__default.createElement(Messages, props), props.renderIsTyping ? props.renderIsTyping(typers) : /*#__PURE__*/React__default.createElement(IsTyping, null), props.renderConnectionBar ? props.renderConnectionBar(chat) : /*#__PURE__*/React__default.createElement(ConnectionBar, {
    renderDelay: 10000
...
var ImagesInput = function ImagesInput(props) {
  ...
  }, _React$createElement["className"] = "ce-upload-document-form", _React$createElement), /*#__PURE__*/React__default.createElement("label", {
    htmlFor: "files",
...
exports.MessageFormSocial = MessageFormSocial;
